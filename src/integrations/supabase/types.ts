...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      likes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "likes_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_actor_profile_fk"
            columns: ["actor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_profile_bio: { Args: { _profile_id: string }; Returns: string }
    }
    Enums: {
